...
void setIsam2Params(const BackendParams& vio_params,
  ...
  //old: isam_param->setCacheLinearizedFactors(false);
  isam_param->cacheLinearizedFactors = false; // new
  //old: isam_param->setEvaluateNonlinearError(true);
  isam_param->evaluateNonlinearError = true; // new
